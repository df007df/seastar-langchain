...
import com.seastar.langchain.core.prompt.base.template.ChatPromptTemplate;
import com.seastar.langchain.core.prompt.base.template.HumanMessagePromptTemplate;
import com.seastar.langchain.core.prompt.base.template.SystemMessagePromptTemplate;
...
public class Demo extends SpringBootApplicationTests {
    ...
    public void llmTest() {
        ...
        LLMChain<ChatCompletionRequest, ChatCompletionResult> llmChain = new LLMChain<ChatCompletionRequest, ChatCompletionResult>(chatOpenAI, chatPromptTemplate);
